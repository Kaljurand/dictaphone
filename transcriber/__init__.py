...
# Based on: client.py from https://github.com/alumae/kaldi-gstreamer-server
...
def transcribe(audiofile, uri, content_type, rate, save_adaptation_state_filename=None, send_adaptation_state_filename=None):
    """
    """
    ...
    ws = MyClient(audiofile, uri + '?%s' % (urllib.urlencode([("content-type", content_type)])),
                    byterate=rate,
                    save_adaptation_state_filename=save_adaptation_state_filename,
                    send_adaptation_state_filename=send_adaptation_state_filename)
    ws.connect()
...
def main():
    ...
    print transcribe(args.audiofile, args.uri, args.content_type, args.rate, save_adaptation_state_filename=args.save_adaptation_state, send_adaptation_state_filename=args.send_adaptation_state)
